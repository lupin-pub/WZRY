#ifndef _YSSKILLBUTTON_H_
#define _YSSKILLBUTTON_H_
...
public:
	...
	static void YSNorSkill();
	static void YSSkillOne();
	static void YSSkillTwo();
	static void YSSkillThree();
