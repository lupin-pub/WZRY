...
void HYSkillButton::HYNorSkill() {

	Scene* scene = Director::getInstance()->getRunningScene();
	Houyi * hero = static_cast<Houyi*>((static_cast<HYGameScene *>(scene))->getChildByName("enemy"));	//hero->setIsAttacking(3);
	//hero->setIsAttacking(4);
	//shoot函数
	SpriteFrameCache::getInstance()->addSpriteFramesWithFile("GameItem/HY/animation.plist", "GameItem/HY/animation.png");
	AnimationCache::getInstance()->addAnimationsWithFile("GameItem/HY/animation.plist");
...
void HYSkillButton::HYSkillThree()
