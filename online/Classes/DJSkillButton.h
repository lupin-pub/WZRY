#ifndef __DJSKILLBUTTON_H__
#define __DJSKILLBUTTON_H__
...
public:
	...
	static void DJNorSkill();
	static void DJSkillOne();
	static void DJSkillTwo();
	static void DJSkillThree();
	// 技能冷却完毕回调
