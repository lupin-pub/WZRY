...
void DJSkillButton::DJNorSkill()
{
	Scene* scene = Director::getInstance()->getRunningScene();
	Daji * hero = static_cast<Daji*>((static_cast<DJGameScene *>(scene))->getChildByName("enemy"));
...
void DJSkillButton::DJSkillOne()
{
	Scene* scene = Director::getInstance()->getRunningScene();
	Daji * hero = static_cast<Daji*>((static_cast<DJGameScene *>(scene))->getChildByName("enemy"));	//hero->setIsAttacking(1);
...
void DJSkillButton::DJSkillTwo()
{
	Scene* scene = Director::getInstance()->getRunningScene();
	Daji * hero = static_cast<Daji*>((static_cast<DJGameScene *>(scene))->getChildByName("enemy"));	//hero->setIsAttacking(2);
...
void DJSkillButton::DJSkillThree()
{
	Scene* scene = Director::getInstance()->getRunningScene();
	Daji * hero = static_cast<Daji*>((static_cast<DJGameScene *>(scene))->getChildByName("enemy"));	//hero->setIsAttacking(3);
