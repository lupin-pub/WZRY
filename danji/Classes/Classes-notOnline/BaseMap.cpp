...
void BaseMap::addMonsters(float dt)
{
	...
	auto sprite3 = paoCar::createMonster(Vec2(200,90),2);
	...
	auto sprite7 = paoCar::createMonster(Vec2(790,480),1);//位置不知道哎
...
bool BaseMap::initMap()
{
	...
	/*auto sprite1 = Sprite::create("YSfront.png");
	sprite1->setPosition(200, 200);
	sprite1->runAction(MoveBy::create(10,Vec2(100, 100)));
	addChild(sprite1);
	auto sprite2 = Sprite::create("YSfront.png");
	sprite2->setPosition(sprite1->getPosition());
	addChild(sprite2);*/

	

	schedule(schedule_selector(BaseMap::addMonsters), 50);
